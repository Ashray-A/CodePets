...
const mockPet = {
  ...
  evolutionHistory: [
    { stage: 'egg', date: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000).toISOString(), experience: 0 },
    { stage: 'baby', date: new Date(Date.now() - 25 * 24 * 60 * 60 * 1000).toISOString(), experience: 100 },
    { stage: 'teen', date: new Date(Date.now() - 20 * 24 * 60 * 60 * 1000).toISOString(), experience: 500 },
    { stage: 'junior', date: new Date(Date.now() - 15 * 24 * 60 * 60 * 1000).toISOString(), experience: 1200 },
    { stage: 'adult', date: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000).toISOString(), experience: 2500 }
  ],
  stats: {
